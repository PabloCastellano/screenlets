...
epydoc:
	epydoc --html --output=docs/epydoc --name="Screenlets 0.0.13" screenlets screenlets.backend screenlets.options screenlets.utils screenlets.session screenlets.services screenlets.sensors
