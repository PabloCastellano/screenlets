# Screenlets main module 
# (c) RYX aka Rico Pfaus <ryx@ryxperience.com> 2007
#     Whise aka Helder Fraga <helder.fraga@hotmail.com> 2008
#     Natan Yellin (Aantn) <aantny@gmail.com> 2008
#     Guido Tabbernuk <boamaod@gmail.com> 2010-2011
...
#				self.window.set_type_hint(gtk.gdk.WINDOW_TYPE_HINT_UTILITY)
		...
		if show_window:
			self.window.show()
			if not os.path.exists(DIR_CONFIG + '/' + self.get_short_name() + '/default/'+ self.id + '.ini'):
				self.first_run = True
			self.window.hide()	
