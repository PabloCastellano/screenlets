...
class OptionGroup (list):
	...
	def __init__ (self, group, name, info=''):
		self._name	= name
		self._info	= info
...
class EditableOptions:
	...
	def add_options_group (self, group, name, group_info):
...
class OptionsDialog (gtk.Dialog):
	...
	def set_info (self, group, name, info, copyright='', version='', icon=None):
...
if __name__ == "__main__":
	...
	class TestObject (EditableOptions):
		...
		def __setattr__(self, group, name, value):
