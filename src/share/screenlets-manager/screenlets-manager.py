...
class ScreenletsManager(object):
	...
	def create_ui (self):
		...
		but1.set_tooltip_text("Launch/add a new instance of the selected Screenlet ...")
		but2.set_tooltip_text("Install a new Screenlet, SuperKaramba or Web Widget or Web Application  ...")
		but3.set_tooltip_text("Permanently uninstall/delete the currently selected Screenlet ...")
		but4.set_tooltip_text("Reset this Screenlet configuration (will only work if Screenlet isn't running)")
		but5.set_tooltip_text("Install new theme for this screenlet")
		but6.set_tooltip_text("Restart all Screenlets that have auto start at login")
		but7.set_tooltip_text("Close all Screenlets running")
		but8.set_tooltip_text("New Screenlets Options/Properties")
		but9.set_tooltip_text("Create a Desktop shortcut for this Screenlet")
		...
		but_about.set_tooltip_text("Show info about this dialog ...")
		but_download.set_tooltip_text("Download more screenlets ...")
		but_close.set_tooltip_text("Close this dialog ...")
