...
#  KclockScreenlet (c) Helder Fraga aka whise <helder.fraga@hotmail.com>
...
class KclockScreenlet (screenlets.Screenlet):
...
if __name__ == "__main__":
	...
	screenlets.session.create_session(KclockScreenlet)
